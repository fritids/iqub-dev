...
function get_image( $args = array() ) {
    ...
    $defaults = array(
        ...
        //'img_resize'=> get_setting( 'image_resize', false ),
        //'quality'   => get_setting( 'image_quality' ),
        //'tt_align'  => get_setting( 'image_alignment' ),
        //'zc'        => get_setting( 'image_zc' )
    );
    ...
    if ( 'rel' == $type || 'url' == $type ) {
        ...
        $anchor_attr = array();
        $href = $rel = $link_class = false;

        if ( 'url' == $type ) {
            if ( is_single() ) {
                $href = $image_url;
                $rel = $link_class = 'lightbox';
            }
