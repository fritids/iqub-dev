...
class SpyropressThemeVerifier {
    ...
    function verify_theme_step1() {
        ...
        if ( $json['success'] && ! $json['black_listed'] ) {
            ...
            update_option( '_spyropress_envato_verification', $_code );
            update_option( '_spyropress_envato_username', $_username );
            ...
            update_option( '_spyropress_envato_verification', false );
            add_error_section( __( 'Theme Verification Error', 'spyropress' ) );
