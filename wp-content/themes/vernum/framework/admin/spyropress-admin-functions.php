...
function spyropress_validate_setting( $value, $type, $field_id, $section ) {
    ...
    elseif( in_array( $type, array( 'css', 'text', 'textarea', 'editor' ) ) ) {
...
function spyropress_compile_dynamic_styles( $settings, $values, $meta = false ) {
    ...
    // include css minifier
    include_once framework_classes() . 'class-cssmin.php';
    $insertion = CssMin::minify( $insertion );
