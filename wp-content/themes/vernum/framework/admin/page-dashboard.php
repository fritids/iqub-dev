...
<div class="wrap spyropress-wrap">
	...
	<div id="dashboard-widgets" class="metabox-holder columns-2">
		<div id="postbox-container-1" class="postbox-container">
            ...
            <div id="dashboard_theme_info" class="postbox">
				<h3 class="hndle">
					<?php _e( 'Latest Tweets', 'spyropress'); ?>
				</h3>
				<div class="inside">
					<?php spyropress_dashboard_twitter(); ?>
						<br class="clear"/>
				</div>
			</div>
		</div>
		<div id="postbox-container-2" class="postbox-container">
			<div id="dashboard_spyropress_news" class="postbox">
				<h3 class="hndle">
					<?php _e( 'Latest News', 'spyropress'); ?>
				</h3>
				<div class="inside">
					<?php spyropress_dashboard_news(); ?>
						<br class="clear"/>
				</div>
			</div>
			<div id="dashboard_theme_info" class="postbox">
				<h3 class="hndle">
					<?php _e( 'Support Forum', 'spyropress'); ?>
				</h3>
				<div class="inside">
					<?php spyropress_dashboard_forum(); ?>
						<br class="clear"/>
				</div>
			</div>
		</div>
