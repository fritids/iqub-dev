    ...
    class SpyropressBuilder {
        ...
        function init() {
            ...
            $includes = array(
                ...
                /* Loop Modules */
                //'loop_modules/comments_template/comments_template.php',
                //'loop_modules/nex_prev_link/nex_prev_link.php',
                //'loop_modules/post_meta/post_meta.php',
                //'loop_modules/the_content/the_content.php',
                //'loop_modules/teaser/teaser.php',
                //'loop_modules/the_title/the_title.php',

                // Modules                
                //'modules/gallery.php',
                'modules/rich-text/rich-text.php',
                'modules/heading/heading.php',
                'modules/our-faces/our-faces.php',
                'modules/parallax/parallax.php',
                'modules/promo/promo.php',
                'modules/sections/sections.php',
